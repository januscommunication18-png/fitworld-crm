...
<div class="card w-full max-w-md mx-auto">
    <div class="card-body">
        ...
        <div class="text-center mb-6">
            <p class="text-base-content/60">You've been invited to join</p>
            <p class="text-lg font-semibold text-primary">{{ $host->studio_name }}</p>
        </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-base-content/60">
                        Invited as <span class="font-medium text-primary">{{ ucfirst($invitation->role) }}</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('subdomain.invite.accept', ['subdomain' => $host->subdomain, 'token' => $invitation->token]) }}">
            @csrf
            ...
            <button type="submit" class="btn btn-primary w-full">
                ...
                {{ $existingUser ? 'Join Studio' : 'Create Account & Join' }}
            </button>
        </form>
    </div>
</div>
