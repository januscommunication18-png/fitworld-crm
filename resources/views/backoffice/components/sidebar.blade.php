<aside id="admin-sidebar" class="sticky top-0 h-screen z-40 w-64 bg-base-100 border-e border-base-content/10 flex flex-col shrink-0">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        <ul class="menu space-y-0.5 p-0">
            ...
            {{-- Waitlist --}}
            <li>
                <a href="{{ route('backoffice.waitlist.index') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('backoffice.waitlist.*') ? 'bg-primary/10 text-primary font-medium' : 'hover:bg-base-content/5' }}">
                    <span class="icon-[tabler--list-check] size-5 shrink-0"></span>
                    <span>Waitlist</span>
                </a>
            </li>
            ...
            {{-- Newsletter --}}
            <li>
                <a href="{{ route('backoffice.newsletter.index') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('backoffice.newsletter.*') ? 'bg-primary/10 text-primary font-medium' : 'hover:bg-base-content/5' }}">
                    <span class="icon-[tabler--news] size-5 shrink-0"></span>
            ...
            <li>
                <a href="{{ route('backoffice.cms.index') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors {{ request()->routeIs('backoffice.cms.*') ? 'bg-primary/10 text-primary font-medium' : 'hover:bg-base-content/5' }}">
