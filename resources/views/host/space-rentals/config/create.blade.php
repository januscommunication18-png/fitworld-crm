...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold">{{ $trans['space_rentals.add_space'] ?? 'Add Rentable Space' }}</h1>
            <p class="text-base-content/60 mt-1">Configure a space or room for rental bookings.</p>
        </div>
    ...
    <x-form-validate action="{{ route('space-rentals.config.store') }}" :has-files="true">
