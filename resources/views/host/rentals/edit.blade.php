...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold">Edit Rental Item</h1>
            <p class="text-base-content/60 mt-1">Update the details for this rental item.</p>
        </div>
    ...
    <x-form-validate action="{{ route('rentals.update', $rental) }}" method="PUT" :has-files="true">
