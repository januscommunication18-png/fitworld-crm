    ...
    <div class="space-y-6 max-w-4xl">
        ...
        <div class="card bg-base-100">
            <div class="card-body">
                ...
                {{-- Classes Selection --}}
                <div id="classes-items" class="mt-4 hidden">
                            ...
                            @foreach($classPlans as $classPlan)
                                <label class="flex items-center gap-2 cursor-pointer hover:bg-base-300/50 p-1 rounded">
                                    <input type="checkbox" name="applicable_item_ids[]" value="class_{{ $classPlan->id }}"
                                           ...
                                           {{ in_array('class_' . $classPlan->id, old('applicable_item_ids', [])) ? 'checked' : '' }}>
                ...
                {{-- Services Selection --}}
                <div id="services-items" class="mt-4 hidden">
                    <div class="flex items-center justify-between mb-2">
                            ...
                            @foreach($servicePlans as $servicePlan)
                                <label class="flex items-center gap-2 cursor-pointer hover:bg-base-300/50 p-1 rounded">
                                    <input type="checkbox" name="applicable_item_ids[]" value="service_{{ $servicePlan->id }}"
                                           ...
                                           {{ in_array('service_' . $servicePlan->id, old('applicable_item_ids', [])) ? 'checked' : '' }}>
                ...
                <div id="memberships-items" class="mt-4 hidden">
                    <div class="flex items-center justify-between mb-2">
                            ...
                            @foreach($membershipPlans as $plan)
                                <label class="flex items-center gap-2 cursor-pointer hover:bg-base-300/50 p-1 rounded">
                                    <input type="checkbox" name="applicable_item_ids[]" value="membership_{{ $plan->id }}"
                                           ...
                                           {{ in_array('membership_' . $plan->id, old('applicable_item_ids', [])) ? 'checked' : '' }}>
                ...
                <div id="class_packs-items" class="mt-4 hidden">
                    <div class="flex items-center justify-between mb-2">
                            ...
                            @foreach($classPacks as $pack)
                                <label class="flex items-center gap-2 cursor-pointer hover:bg-base-300/50 p-1 rounded">
                                    <input type="checkbox" name="applicable_item_ids[]" value="pack_{{ $pack->id }}"
                                           ...
                                           {{ in_array('pack_' . $pack->id, old('applicable_item_ids', [])) ? 'checked' : '' }}>
                ...
                <div id="specific-items" class="mt-4 hidden">
                    <div class="flex items-center justify-between mb-2">
