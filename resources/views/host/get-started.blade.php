                                ...
                                <form id="studio-info-form" class="p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="join w-full mt-1">
                                            <input id="setup_subdomain" type="text" class="input input-bordered join-item flex-1" value="{{ $host->subdomain ?? '' }}" {{ $host->subdomain ? 'readonly' : 'required' }} placeholder="yourstudio" />
...
<script>
    ...
    // Support drawer functions are provided by the <x-support-drawer /> component
</script>
@endsection
