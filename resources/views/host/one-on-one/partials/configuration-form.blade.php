{{-- Configuration Form Partial --}}
<div class="alert alert-soft alert-warning mb-6">
    <span class="icon-[tabler--alert-triangle] size-5"></span>
    <div>
        <strong>Complete Your Setup</strong>
        <p class="text-sm">Configure your meeting preferences below to start accepting 1:1 bookings.</p>
    </div>
</div>
...
<form id="setup-form" method="POST" action="{{ route('one-on-one-setup.update') }}">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card bg-base-100">
                <div class="card-header">
                    <h3 class="card-title">Daily Limits</h3>
                </div>
                <div class="card-body">
                    <div class="max-w-xs">
                        ...
                        <p class="text-xs text-base-content/60 mt-1">Leave empty for unlimited</p>
