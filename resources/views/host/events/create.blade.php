...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-base-content/60 mt-1">Create a workshop, seminar, or special event.</p>
        </div>
    ...
    <x-form-validate action="{{ route('events.store') }}" :has-files="true">
        <div class="space-y-6">
            {{-- Cover Image --}}
                ...
                <div class="card-body">
                    ...
                    <div id="image-preview-wrapper" class="hidden">
                        <div class="relative group rounded-xl overflow-hidden">
                            <img id="image-preview" src="" alt="Cover image" class="w-full h-44 object-cover">
                    ...
                    <div id="image-upload-zone" class="border-2 border-dashed border-base-content/20 rounded-xl p-6 text-center cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-colors"
                ...
                <div class="card-body space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="switch switch-primary">
                            <input type="checkbox" id="same_day_event" {{ old('same_day_event', true) ? 'checked' : '' }} />
                    ...
                    <div id="dates-row" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-studio-select name="timezone" :options="array_combine($timezones, $timezones)" :selected="$host->timezone ?? 'America/New_York'" placeholder="Select timezone..." :required="true" />
                        </div>
                    </div>
                    ...
                    <div id="physical-location-fields" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="state" name="state" value="{{ old('state') }}" class="input w-full" placeholder="NY">
                            </div>
                            <div>
                                <label class="label-text" for="zip_code">ZIP Code</label>
                                <input type="text" id="zip_code" name="zip_code" value="{{ old('zip_code') }}" class="input w-full">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="online-location-fields" class="space-y-4 hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-studio-select name="online_platform" :options="$platforms" :selected="old('online_platform')" placeholder="Select platform" />
                            </div>
                            <div>
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <x-studio-select name="skill_level" :options="$skillLevels" :selected="old('skill_level', 'all_levels')" placeholder="Select level" />
                        </div>
                        <div>
                            ...
                            <x-studio-select name="audience_type" :options="$audienceTypes" :selected="old('audience_type', 'all')" placeholder="Select audience" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-base-100">
                <div class="card-body space-y-2">
                    ...
                    <a href="{{ route('catalog.index', ['tab' => 'events']) }}" class="btn btn-ghost w-full">
                        Cancel
                    </a>
                </div>
            </div>
