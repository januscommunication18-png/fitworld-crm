...
class Host extends Model
{
    ...
    protected $fillable = [
        ...
        'studio_category',
        'studio_categories',
        'custom_service_plan_categories',
        'disabled_service_plan_categories',
        'custom_rental_item_categories',
        'disabled_rental_item_categories',
        'city',
        'state',
        'zipcode',
        'country',
    ...
    protected function casts(): array
    {
        return [
            ...
            'custom_service_plan_categories' => 'array',
            'disabled_service_plan_categories' => 'array',
            'custom_rental_item_categories' => 'array',
            'disabled_rental_item_categories' => 'array',
